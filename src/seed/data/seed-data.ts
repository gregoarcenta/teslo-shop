  ...
  products: [
    {
      ...
      images: [
        'ql5rsw3bnebyjp8sun3r.jpg',
        'evjw10lt3xnszvo2ar4z.jpg',
      ],
      stock: 7,
      price: 75,
    ...
    },
    {
      ...
      images: [
        'xcw7s3w9fmai1anrcdwf.jpg',
        'ii0ye9u0elcuohv6lhuq.jpg',
      ],
      stock: 5,
      price: 200,
      sizes: ['XS','S','M','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'slgkaokfwhclfm1nkgqb.jpg',
        'cfzyv2ych227ylyeik55.jpg'
      ],
      stock: 10,
      price: 130,
      sizes: ['S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'g4vtixxu4a0slzokntjm.jpg',
        'ls6tpmiwzmzqf5rbp0wp.jpg',
      ],
      stock: 50,
      price: 45,
      sizes: ['XS','S','M','L'],
    ...
    },
    {
      ...
      images: [
        's6xa6iiwa7pew6rpymbq.jpg',
        'rbdytanmlswsynecpqbh.jpg',
      ],
      stock: 50,
      price: 40,
      sizes: ['M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'jhrgh2z0wuscq5g9ibrn.jpg',
        'nbfzdsk4irzqhnwws4ax.jpg',
      ],
      stock: 0,
      price: 35,
      sizes: ['M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'stpdx61ys7qjlzvx2ivr.jpg',
        'm5hj69o9phnr8i4gtiiy.jpg',
      ],
      stock: 15,
      price: 35,
      sizes: ['S','M','L','XL'],
    ...
    },
    {
      ...
      images: [
        'edmxaxsgj5zdtydh650i.jpg',
        'sqq02mlvi0rtktntujtp.jpg',
      ],
      stock: 17,
      price: 35,
      sizes: ['XS','S','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'qrbbmrd7dohnghmlpys9.jpg',
        'dtbrf04unj3jqn0tbpqc.jpg',
      ],
      stock: 12,
      price: 35,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'xuusu8rydjbjccajc0pj.jpg',
        'jimzm0a4ov6f06mvwgoa.jpg',
      ],
      stock: 5,
      price: 35,
      sizes: ['XS','S'],
    ...
    },
    {
      ...
      images: [
        'kptuuxqwxke7j1am7ye4.jpg',
        'tuolt6bu4kxnqjoxdty7.jpg',
      ],
      stock: 2,
      price: 35,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'caymuimfu8u7a9scettm.jpg',
        'x6wlbxzkbu1dgviesnta.jpg',
      ],
      stock: 82,
      price: 35,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'm08irb9crjfvpzeajcj6.jpg',
        'sgnnqirw3gdof1l9vri8.jpg',
      ],
      stock: 24,
      price: 35,
      sizes: ['XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'iwilapbk8iipfrjvcpe6.jpg',
        'h3diqni3hku0zly0crzc.jpg',
      ],
      stock: 5,
      price: 30,
      sizes: ['XS','S','XXL'],
    ...
    },
    {
      ...
      images: [
        'k5hrpenr5sk0v3lk6p5s.jpg',
        'sygfeaheuyfjfznglryy.jpg',
      ],
      stock: 150,
      price: 30,
      sizes: ['M','L'],
    ...
    },
    {
      ...
      images: [
        'pp7chx6hp1aftccuzfrk.jpg',
        'wvrtie9fowo2ziempmy4.jpg',
      ],
      stock: 10,
      price: 35,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'l2rircfupcndjx4jnr6r.jpg',
        'vfs1zego7i9s8n96x1cw.jpg',
      ],
      stock: 34,
      price: 35,
      sizes: ['XS','S','M','L'],
    ...
    },
    {
      ...
      images: [
        'ngblxebozstd6x3rrrci.jpg',
        'xceinpdzirjishdr2evi.jpg',
      ],
      stock: 15,
      price: 40,
      sizes: ['XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'eurlhawpyotakmhe6vyt.jpg',
        'xhltheyelq8ccuifllnj.jpg',
      ],
      stock: 12,
      price: 40,
      sizes: ['XS','XXL'],
    ...
    },
    {
      ...
      images: [
        'juu2qbdiafjwdd4epdv0.jpg',
        'eeqzsttdagmnxjq4kz4g.jpg',
      ],
      stock: 10,
      price: 115,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'yccsuzprxfkbqf6wz4jy.jpg',
        'ao951n6zu1za8a8rbtdk.jpg',
      ],
      stock: 10,
      price: 130,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'ekwirnmvdg2egqvlwldx.jpg',
        'lyvnitudfzcxqakbzods.jpg',
      ],
      stock: 100,
      price: 85,
      sizes: ['XS','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'tcqevtdme1enh7akfuao.jpg',
        'ryieaxo7i9ub7sfkfa6y.jpg',
      ],
      stock: 7,
      price: 85,
      sizes: ['XS','S','M'],
    ...
    },
    {
      description: "Introducing the Tesla Chill Collection. The Men’s Chill Quarter Zip Pullover has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The pullover features subtle thermoplastic polyurethane Tesla logos on the left chest and below the back collar, as well as a custom matte zipper pull. Made from 60% cotton and 40% recycled polyester.",
      images: [
        'mhjn5tmbcvexhervvfiy.jpg',
        'liwlagit1kklewbpwelf.jpg',
      ],
      stock: 15,
      price: 85,
      sizes: ['XS','S','M','L'],
    ...
    },
    {
      ...
      images: [
        'hmq1bj9k6h2opay10yxg.jpg',
        'rjcjeffn0jc247dfbdre.jpg',
      ],
      stock: 15,
      price: 70,
      sizes: ['XS','S','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'ormhegiv58arvfdivuc4.jpg',
        'uvkwrwbmppitarmcw3rh.jpg',
      ],
      stock: 13,
      price: 60,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'tauzsezzrzpero8mwwqs.jpg',
        'ce01qilnaedkx5xebxu2.jpg',
      ],
      stock: 11,
      price: 30,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      description: "The Relaxed T Logo Hat is a classic silhouette combined with modern details, featuring a 3D T logo and a custom metal buckle closure. The ultrasoft design is flexible and abrasion resistant, while the inner sweatband includes quilted padding for extra comfort and moisture wicking. The visor is fully made from recycled plastic bottles. 100% Cotton.",
      images: [
        'xjsfsi4dmrnulzhmpdck.jpg',
        'dtizift2tvhwsc1ib5g0.jpg',
      ],
      stock: 13,
      price: 35,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'majbtc3jg6lp1s7fizlr.jpg',
        'fomvyjwrhjetrxbtmwxg.jpg',
      ],
      stock: 85,
      price: 225,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'g7ticy6g6daltmhypjsq.jpg',
        'yfihavvuwhf4ukpltrdt.jpg',
      ],
      stock: 10,
      price: 130,
      sizes: ['XS','S','M','XXL'],
    ...
    },
    {
      ...
      images: [
        'gyltscxkpnfufgowvitp.jpg',
        'nn1agtmktqeeksswrt2q.jpg',
      ],
      stock: 9,
      price: 110,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'uenvzsvslyh6zput1al1.jpg',
        'iglmfla08a4adgl2troa.jpg',
      ],
      stock: 10,
      price: 45,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'xk6fkv2sngq57qeurjtq.jpg',
        'mdmhkiq8umsjitedzdyq.jpg',
      ],
      stock: 0,
      price: 40,
      sizes: ['XS','S'],
    ...
    },
    {
      ...
      images: [
        'h912rcukrejrf8c4tr5e.jpg',
        'vsgqdeoz8epxcf2ljgiz.jpg',
      ],
      stock: 30,
      price: 35,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'uv81i1cgjkogzzdqmopa.jpg',
        'xszdxwh2ggggcwkczgg6.jpg',
      ],
      stock: 16,
      price: 40,
      sizes: ['XS','S','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'x3cgvdtqht9xlh00pw9x.jpg',
        'a2z1infka9nz9ujqy42h.jpg',
      ],
      stock: 18,
      price: 35,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'iftectnwkkccvx6oj3h2.jpg',
        'isfcih9jcdd4fh0wcym1.jpg',
      ],
      stock: 5,
      price: 35,
      sizes: ['XL','XXL'],
    ...
    },
    {
      description: "Designed to celebrate Tesla's incredible performance mode, the Plaid Mode Tee features great fit, comfort and style. Made from 100% cotton, it's the next best thing to riding shotgun at the Nürburgring.",
      images: [
        'bg6xp5vkxwjgqquqapad.jpg',
        'rtilqsounmqzaxgqo3t9.jpg',
      ],
      stock: 16,
      price: 35,
      sizes: ['S','M'],
    ...
    },
    {
      ...
      images: [
        'ndh9yh8zbwhajzmvv2so.jpg',
        't9ehknmswn33gogqbl9d.jpg',
      ],
      stock: 10,
      price: 130,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'tkjphglbok6ynfwyo4ym.jpg',
        'yytegy5iab2ahtbfwrsy.jpg',
      ],
      stock: 3,
      price: 90,
      sizes: ['M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'z4u3pinzgbmmqrmjwtil.jpg',
        'gi1nsepqp9pz6qy2jk4r.jpg',
      ],
      stock: 162,
      price: 100,
      sizes: ['XS','S','M','L','XL','XXL'],
    ...
    },
    {
      ...
      images: [
        'uih2nqskgmvf2essrgx5.jpg',
        'dqaogzjibh3puuhnaov5.jpg',
      ],
      stock: 10,
      price: 30,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'tdflfa4jjkrpyth2b6of.jpg',
        'wnkgp1fspnmotdl1f9qb.jpg',
      ],
      stock: 0,
      price: 25,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'o5jt1kij2wziqqyynmu7.jpg',
        'qmzeyjgch7yo2a9xzrco.jpg',
      ],
      stock: 10,
      price: 25,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        's3nm5saoxwdpaekyr7ek.jpg',
        'luje1k8ygfydqkfgm7fk.jpg',
      ],
      stock: 10,
      price: 30,
      sizes: ['XS','S','M'],
    ...
    },
    {
      description: "Designed for fit, comfort and style, the Tesla T Logo Tee is made from 100% Peruvian cotton and features a silicone-printed T Logo on the left chest.",
      images: [
        'rapn0tpv33kyhkp1nbuu.jpg',
        'tqkfl7tawdk7xxtnqxbr.jpg',
      ],
      stock: 10,
      price: 30,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'orstfpjo1ucjhahpqqlx.jpg',
        'zhzu86uicqefwdb5uxco.jpg',
      ],
      stock: 10,
      price: 30,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'bfbpinshm5fyp5hzhtf7.jpg',
        'v4p2ededuzd8ew96f6so.jpg',
      ],
      stock: 16,
      price: 25,
      sizes: ['XS','S'],
    ...
    },
    {
      ...
      images: [
        'hreel3iswmtkvua2gv7v.jpg',
        'zpzcycnfekxdnej6uw2s.jpg',
      ],
      stock: 0,
      price: 30,
      sizes: ['XS','S'],
    ...
    },
    {
      ...
      images: [
        'jubtrhpjdjtqifqrfeuf.jpg',
        'tpwkiy6wuqv8bzdqihgo.jpg',
      ],
      stock: 10,
      price: 30,
      sizes: ['XS','S'],
    ...
    },
    {
      ...
      images: [
        'tulwwvm8dvoswhvu39l8.jpg',
        'ezl7cgvslsg03mhdf1bt.jpg',
      ],
      stock: 10,
      price: 65,
      sizes: ['XS','S','M'],
    ...
    },
    {
      ...
      images: [
        'crere1lkjuxjhgfgvdif.jpg',
        'isxtmwtwrkrxir5c39to.jpg',
      ],
      stock: 10,
      price: 30,
      sizes: ['XS','S','M'],
